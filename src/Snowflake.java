...
public class Snowflake {
     ...
     */
    private static long TWEPOCH = 946656000000L;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(10000);
        threads.stream().forEach(new Consumer<Thread>() {
            @Override
...
//        946656010
        ...
        Thread.sleep(10000);
        threadArrayList.stream().forEach(new Consumer<Thread>() {
            @Override
            public void accept(Thread thread) {
                thread.stop();
            }
        ...
        for (String aa : arrayList) {
            if (aa != null && list.contains(aa)) {
               list3333.add(aa);
            }
        }

        System.out.println(list3333.size());
