...
public class Philosopher extends Thread {
    ...
    private com.tuling.jucdemo.threadactiveness.Chopstick left;
    private com.tuling.jucdemo.threadactiveness.Chopstick right;

    public Philosopher(String name, com.tuling.jucdemo.threadactiveness.Chopstick left, Chopstick right) {
        super(name);
        this.left = left;
        this.right = right;
    }
